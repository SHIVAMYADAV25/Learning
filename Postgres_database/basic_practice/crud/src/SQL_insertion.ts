...
async function createUser(username: string, password: string) {
  ...
  //  If user sends malicious input,
  // this query can be modified and database can be damaged
  await client.query(query);
}

Problems / Issues with SQL INSERTION
1 SQL Injection Attack (Biggest Problem)

Problem:
If SQL queries are written using string concatenation, hackers can inject malicious SQL.
...

{
 ...
 This can delete your table.

 Solution (What you did correctly)
